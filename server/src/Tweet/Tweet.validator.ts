...
export const tweetValidation = {
    tweetValidation: (req: typeof ExpressRequest, res: typeof ExpressResponse, next: typeof ExpressNext) => {
    ...
    commentValidation: (req: typeof ExpressRequest, res: typeof ExpressResponse, next: typeof ExpressNext) => {
        const joiSchema = Joi.object({
            text: Joi.string().required(),
    ...
    tweetIdValidation: (req: typeof ExpressRequest, res: typeof ExpressResponse, next: typeof ExpressNext) => {
        const joiSchema = Joi.object({
