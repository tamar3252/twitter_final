...
routerTweet.get("/tweets_with_follower",authUser,TweetCtrl.getTweetsWithFollower)//לבדוק
routerTweet.get("/tweet",TweetCtrl.getTweet)//also for guest
routerTweet.post("/add_tweet",authUser,TweetCtrl.addTweet)
routerTweet.post("/add_comment_to_tweet",authUser,TweetCtrl.addComment)
